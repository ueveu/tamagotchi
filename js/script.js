...
function updateHealth(value) {
  ...
  if (health < 0) {
    // Überprüfen, ob Gesundheit unter 0 liegt
    health = 0; // Gesundheit auf Minimum setzen
  } else if (health > 100) {
    // Überprüfen, ob Gesundheit über 100 liegt
...
function checkHealth() {
  if (health <= 0) {
    ...
    // Überprüfen, ob Zufriedenheit niedrig ist
...
function updateHappiness(value) {
  ...
  if (happiness < 0) {
    // Überprüfen, ob Zufriedenheit unter 0 liegt
    happiness = 0; // Zufriedenheit auf Minimum setzen
  } else if (happiness > 100) {
    // Überprüfen, ob Zufriedenheit über 100 liegt
